    ...
    <div className="relative w-full min-h-screen">
      ...
      <div className="relative z-10 w-full min-h-screen flex flex-col items-center justify-center px-4 py-16 text-white">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <h2 className="mb-3 text-xl">  <strong>RSVP Now and receive </strong></h2>
        <h2 className="mb-6 text-2xl text-blue-400"> <strong>10 Duas and Hadiths to Encompass All Matters.</strong> </h2>
